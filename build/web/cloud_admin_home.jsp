<%-- 
    Document   : cloud_admin_home
    Created on : Jun 18, 2016, 10:44:53 AM
    Author     : IVS PC5
--%>
...
<div id="wrapper">
	...
	<div id="menu">
		<ul class="dark_menu">
			...
			<li><a href="hospital_registration.jsp">Registration</a></li>
			<li ><a href="view_hospital.jsp">Hospital</a></li>
			
                        
                        <li><a href="change_pass.jsp">Change Password</a>
                        </li>

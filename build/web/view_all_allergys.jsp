...
<!--                                         <form action="action/allergy_report_action.jsp" name="contact"method="post">-->
                                            <a href="view_pat_1.jsp"> <img style="left:540px;  position: relative; height: 25px; width: 25px;" src="images/delete-icon.png"/></a>
                                            <h2 style="left: 250px;top:-15px; position: relative;">
                                                <font style="font-size: 24px;font-family:sans-serif;color: cornflowerblue;">Allergies</font>  </h2> 
                                            <center>
                                                ...
                                                <table border="2">
                                                    ...
                                                    ResultSet rs=null;
                                                     rs=db.getData("select * from allergytb where patient_id='"+pid+"'");
                                                     while(rs.next())
                                                     {

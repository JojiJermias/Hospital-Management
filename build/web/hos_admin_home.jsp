<%-- 
    Document   : hos_admin_home
    Created on : Jun 16, 2016, 5:26:41 PM
    Author     : IVS PC5
--%>
...
<div id="wrapper">
	...
	<div id="menu">
		<ul class="dark_menu">
			...
			<li><a href="add_emergency_doc.jsp">Emergency</a></li>
		...
		<div id="sidebar">
			<ul>
				...
				<li>
                    ...
                    <div style="width:270px; height:60px; background: white;padding:40px; border: 1px #1e94b2 solid; position: absolute;left:815px; top:550px;">

<%-- 
    ...
    Created on : Jun 16, 2016, 5:24:55 PM
    Author     : IVS PC5
--%>
	...
	<div id="menu">
		<ul class="dark_menu">
			...
			<li><a href="#">Registration</a>
                        <ul>
                                <li><a href="patient_registration.jsp">Patient</a></li>
                                 <li><a href="add_patient.jsp">Add Patient</a></li>
                        </ul> </li>
                        <li ><a href="view_pat_2.jsp">view</a></li>
			<li><a href="view_fee.jsp">fees</a></li>
		...
		<div id="sidebar">
			<ul>
                            <%
                                String rec="";
                                try{
                                    rec=session.getAttribute("username").toString().toUpperCase();
                                }catch(Exception e){

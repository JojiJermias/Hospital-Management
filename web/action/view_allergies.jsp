<%-- 
    Document   : view_allergies
    Created on : 7 May, 2014, 12:56:42 PM
    Author     : IVS PC5
--%>
        ...
        <%
           ...
           // //JOptionPane.showMessageDialog(null, deepp+"  "+dep);
            if(cur_hos_id==hos_id){
                ...
                String sss="select * from allergytb where patient_id='"+p_id+"'";
               // //JOptionPane.showMessageDialog(null, sss);
                ...
                if(type.equals("doctor")){
                    if(key.contains("DOALL")){
                        ...
                        response.sendRedirect("allergy_down_action.jsp");
                    }

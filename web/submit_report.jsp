		...
		<div id="content">
			...
			<div class="post">
				<%
                                ...
                                <div class="entry">
                                     <div id="reg">
                                        <form action="action/medical_report_action.jsp" name="contact"method="post">
                                            <a href="view_pat_1.jsp"> <img style="left:440px;  position: relative; height: 25px; width: 25px;" src="images/delete-icon.png"/></a>
                                        <h2 style="left: 115px;top:-15px; position: relative;">Report</h2>                                        
                    <label for="name">Create Report:</label>
                    <textarea  name="report" id="re"></textarea><span id="regname" style="display:none;color:red"><median>Invalid Entry</median> </span>

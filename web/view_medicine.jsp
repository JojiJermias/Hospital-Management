...
<!--                    <div id="banner"><img style="position: relative; width: 700px; height: 150px;left:100px; border: white solid thick;" src="images/urll.jpeg" alt="" /></div>-->
			<div class="post">
				<%
                                ...
                                <div class="entry">
                                    <div id="reg">
                                        <form action="action/view_medicine_action.jsp" name="contact"method="post">
                                            <a href="pharmacist_home.jsp"> <img style="left: 340px;  position: relative; height: 25px; width: 25px;" src="images/delete-icon.png"/></a>

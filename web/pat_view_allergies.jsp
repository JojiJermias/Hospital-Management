<%-- 
    Document   : pat_view_allergies
    Created on : Jun 17, 2016, 11:34:46 AM
    Author     : IVS PC5
--%>
...
<a href="view_medical_p.jsp"> <img style="left:540px;  position: relative; height: 25px; width: 25px;" src="images/delete-icon.png"/></a>
                                            <u><center><font style="font-size: 24px;font-family:sans-serif;color: cornflowerblue; ">Allergies</font></center></u>   
                                            <center>
                                                <br>
                                                    <br>
                                                        <br>
                                                <table border="2">
                                                    ...
                                                    ResultSet rs=null;
                                                     rs=db.getData("select * from allergytb where patient_id='"+user_id+"'");
                                                     while(rs.next())
                                                     {

	...
	<div id="menu">
		<ul class="dark_menu">
			<li><a  href="doctor_home.jsp">Home</a></li>
                        <li><a href="view_pat.jsp">Personal</a></li>
			<li><a href="" class="selected">Applications</a>
                        </li>
                    ...
                    <div class="post">
                      <!--   <  
                        ...
                        <sql:setDataSource
                            ...
                            url="jdbc:mysql://localhost/phr"
                            user="root" password=""
                            />
                        <sql:query var="policy" dataSource="${db}">
                            SELECT *, pa.status pstatus FROM patients p, policyapplication pa where p.id = pa.patientid;
                        </sql:query>	
                        <div class="entry">
                            <div id="reg">
                                <table border="1" cellpadding="0">
                                    ...
                                    <c:forEach var="user" items="${policy.rows}">
                                        <tr>
                                            <td><c:out value="${user.name}" /></td>
                                            <td><c:out value="${user.department}" /></td>
                                            <td><c:out value="${user.mobile}" /></td>
                                            <td><c:out value="${user.email}" /></td>
                                            <td><c:out value="${user.place} ${user.district}" /></td>
                                            ...
                                            <td>
                                                <c:if test="${user.status == 0}">
                                                    <a href="action/changeapplystatus.jsp?id=${user.id}&aid=${user.appid}&do=2">Approve</a>
                                                </c:if>
                                                <c:if test="${user.status == 0}">
                                                    <a href="action/changeapplystatus.jsp?id=${user.id}&aid=${user.appid}&do=3" style="color: red">Reject</a>
                                                </c:if>
                                            </td>
                                        </tr>
                                    </c:forEach>

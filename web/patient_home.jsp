<%-- 
    ...
    Created on : Jun 16, 2016, 5:22:40 PM
    Author     : IVS PC5
--%>
	...
	<div id="menu">
		<ul class="dark_menu">
			<li><a  href="#" class="selected">Home</a></li>
                        <li><a href="action/view_patient_personal.jsp">Personal</a></li>
                        <li ><a href="action/view_patient_medical.jsp">Medical</a></li>
<!--                        <li><a href="">View Hospital History</a></li>-->
	...
	<div id="page">
        ...
        String sql="select name from patients where id='"+uid+"'";

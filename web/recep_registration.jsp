<%-- 
    Document   : recep_registration
    Created on : Jun 16, 2016, 4:18:07 PM
    Author     : IVS PC5
--%>
...
<!--                    <div id="banner"><img style="position: relative; width: 700px; height: 150px;left:100px; border: white solid thick;" src="images/urll.jpeg" alt="" /></div>-->
			<div class="post">
				<%
                                ...
                                <div class="entry">
                                    <div id="reg">
                                        <form action="action/recep_register_action.jsp">
                                        ...
                                        <label for="Name">Name:</label></td>
                                                <td><input type="text" id="Name" name="Name" placeholder="Receptionist Name" required/></td><td><span id="nam" style="display: none; "><font style="color: red">Characters only</font></span></td></tr>
